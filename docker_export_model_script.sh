...
lemonade -i $MODEL_NAME --cache-dir "/build" oga-load --input_path "/build/phi-4-mini-instruct-01222025/hf_version" --device cuda --dtype fp16 accuracy-mmlu --tests management
